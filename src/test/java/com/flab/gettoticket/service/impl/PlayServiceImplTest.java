...
class PlayServiceImplTest {
    ...
    void findPlayOrder() {
        ...
        //when
        List<PlayOrderListResponse> list = playServiceImpl.findPlayOrder(goodsId, playAt);
    ...
    void findPlayTimeDTO() {
        ...
        //when
        PlayTimeResponse dto = playServiceImpl.findPlayTimeDTO(playTimeId, goodsId);
    ...
    void findSeatCount() {
        ...
        //when
        List<SeatCountResponse> list = playServiceImpl.findSeatCount(playTimeId);
